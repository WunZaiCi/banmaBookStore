 ...
 * bar1 必须与对象名一致
 */
var bar1 = new Q6MenuBar("bar1", "BANMA网络图书商城");
function load() {
	bar1.colorStyle = 2;
	...
	bar1.add("图书管理", "查看图书", "<c:url value='/adminjsps/admin/AdminBookServlet?method=findAll'/>", "body");
	bar1.add("图书管理", "添加图书", "<c:url value='/adminjsps/admin/AdminBookServlet?method=addpre'/>", "body");
